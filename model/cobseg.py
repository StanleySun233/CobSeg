...
"""
CobSeg model definition.

CobSeg: Coherence Boundary Modeling for Dialogue Topic Segmentation

Architecture components:
- Dual-stream representation: sentence-level semantic + token-level lexical
- UBIW: Utterance Boundary Informativeness Weighting
- Directional boundary fusion: end-view + start-view prediction heads
- Topic coherence cue: corpus-level statistical boundary evidence
